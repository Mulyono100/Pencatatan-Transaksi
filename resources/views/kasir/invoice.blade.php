...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="box">
                    <div class="box-body">
                        <form action="/tambahinvoice" method="POST">
                            <div class="row">
                                <div class="col-md-12">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="item-row">
                                                    <td colspan="2">
                                                        <select class="form-control productname" required
                                                            name="product[]" id="select3" style="width: 100%;">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control price" readonly
                                                                    name="priceu[]" type="number">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><input class="form-control qty" required name="qtyy[]"
                                                            type="number"></td>
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input type="number" name="totalharga" readonly
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input class="form-control" required name="total"
                                                                    id="discount" value="0" type="number" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" style="text-align:right;"><button type="submit"
                                                            id="submit"
                                                            class="form control btn btn-success mencoba">Bayar</button>
                                                    </td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="item-row">
                                                    <td colspan="2">
                                                        <select class="form-control productname" required name="product[]" id="select3" style="width: 100%;">
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input class="form-control price" readonly name="priceu[]" type="number">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td><input class="form-control qty" required name="qtyy[]" type="number"></td>
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input type="number" class="form-control total" readonly name="hargatotal[]">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td colspan="4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input type="number" name="totalharga" readonly class="form-control" id="subtotal">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span>
                                                                <input class="form-control" required name="total" id="discount" value="0" type="number" />
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <div class="input-group">
                                                                <span class="input-group-addon">Rp</span><input type="number" class="form-control" readonly name="kembalian" id="grandTotal">
                                                            </div>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="5" style="text-align:right;"><button type="button" id="submit" class="form control btn btn-success mencoba">Bayar</button></td>
    ...
    <!-- <script>
        function bayaran() {
            ...
            $(document).ready(function() {
                var coba = document.getElementById("discount").value;
                var mencoba = parseInt(coba)
                console.log(mencoba)
                var coba1 = document.getElementById("subtotal").value;
                var mencoba1 = parseInt(coba1)
                console.log(mencoba1)

                var mencobalagi = mencoba + mencoba1
                console.log(mencobalagi)

                if (mencoba < mencoba1) {
                    swal("Maaf", "Uang Anda tidak mencukupi", "error")
    ...
    $(document).ready(function() {
        ...
        //     var bayar = $("#discount").val();
        //     var totalharga = $("#subtotal").val();
        //     var kembalian = $("#grandtotal").val();
        //     if (bayar < totalharga) {
        //         swal("Maaf", "Uang Anda Tidak Mencukupi", "warning");
        ...
        //             success: function() {
        //                 window.location = "/transaksiview/" + data.id
        //             },
        //             error: function(e) {
        //                 console.log(e);
        //             }
        ...
        $(document).on('change', '.productname', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    a.find('.keuntungan').val(data.keuntungan);
    ...
    Invoice.prototype = {
        ...
        newRow: function() {
            jQuery(".item-row:last").after(
                '<tr class="item-row"><td colspan="1"></td><td class="item-name"><div class="delete-btn"><select class="productname select1" name="product[]" style="width: 100%;"><option selected="selected">-Pilih Barang-</option>@foreach($product as $b)<option value="{{$b->id}}">{{$b->nama}}</option>@endforeach</select></div></td><td><div class="form-group"><div class="input-group"> <span class="input-group-addon">Rp</span><input class="form-control price" readonly name="priceu[]"  type="text"> </div></div></td><td><input class="form-control qty" name="qtyy[]" type="text"></td><td><div class="form-group"><div class="input-group"><span class="input-group-addon">Rp</span><input type="text" readonly class="form-control total" name="hargatotal[]"><td><a class=' +
                $.opt.delete.substring(1) +
                ' href="javascript:;" title="Remove row">Hapus</a></div></div> </td></td></tr>');
            $('.select1').select2()
