                    ...
                    <div class="col-md-12">
                        <div class="box">
                            <div class="box-header">
                                <h3 class="box-title">PROFIL KASIR</h3>
                            </div>
                            <!-- /.box-header -->
                            <div class="box-body">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form action="/profile/ubah/{{$profile->id}}" method="post">
                                            {{ csrf_field() }}

                                            <div class="form-group">
                                                <label for="formGroupExampleInput">ROLE</label>
                                                <input name="role" type="text" class="form-control" id="formGroupExampleInput" readonly value="{{$profile->role}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">NAME</label>
                                                <input name="nama" type="text" class="form-control" id="formGroupExampleInput" value="{{$profile->name}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">EMAIL</label>
                                                <input name="email" type="text" class="form-control" id="formGroupExampleInput" value="{{$profile->email}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">USERNAME</label>
                                                <input name="username" type="text" class="form-control" id="formGroupExampleInput" value="{{$profile->username}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="formGroupExampleInput">PASSWORD</label>
                                                <input name="password" type="password" class="form-control" id="formGroupExampleInput" value="{{$profile->password}}">
                                            </div>
