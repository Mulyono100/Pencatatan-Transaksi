                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="item-row">
                                                    <td colspan="2">
                                                        <select class="form-control productname" required name="suplier" id="select3" style="width: 100%;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            ...
                                                            <input id="totalQty" name="totalQty" readonly class="form-control">
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="6" style="text-align:right;"><button type="submit" id="submit" class="form control btn btn-success mencoba">Bayar</button></td>
 ...
 */
        ...
        Invoice.prototype = {
             ...
             */
            newRow: function() {
                jQuery(".item-row:last").after('<tr class="item-row"><td colspan="2"></td><td class="item-name"><div class="delete-btn"><select class="productname select4" name="product[]" id="select4" style="width: 100%;"><option selected="selected" disabled="true">-Pilih Barang-</option>@foreach($barang as $b)<option value="{{$b->id}}">{{$b->nama}}</option>@endforeach</select></div></td><td><div class="form-group"><div class="input-group"><span class="input-group-addon">Rp</span><input class="form-control price" readonly name="priceu[]"  type="text"> </td></div></div><td><input class="form-control qty" name="qtyy[]" type="text"></td><td><div class="form-group"> <div class="input-group"><span class="input-group-addon">Rp</span> <input type="text" readonly class="form-control total"  name="hargatotal[]"><td><a class=' + $.opt.delete.substring(1) + ' href="javascript:;" title="Remove row">Hapus</a></td></td></div></div></tr>');
