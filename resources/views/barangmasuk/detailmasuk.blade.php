                                        ...
                                        <div class="col-xs-12 col-md-12">
                                            ...
                                            <div class="row">
                                                <div class="col-xs-6 col-md-6">
                                                    <address>
                                                        <?php $tanggal1 = date('d M Y', strtotime($barangmasuk->tanggal)) ?>
                                                        <strong>TANGGAL:</strong>
                                                        {{$tanggal1}}<br />
                                                        <strong> KODE MASUK: </strong>{{$barangmasuk->kode_masuk}}
                                                    </address>
                                                </div>
                                                <div class="col-xs-6 col-md-6">
                                                    <address><br>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>Rp. {{$coba11}}</td>
                                                <td>{{$masuk->jumlah_beli}}</td>

                                                <?php $total = $masuk->total_harga; ?>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-xs-4 col-md-4"><b> HORMAT KAMI</b><br><br><br>( {{$masuk->suplier->nama}} )</div>
                                                <div class="col-xs-2 col-md-2"></div>
