                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="/kategoribarang/create" method="POST">
                                                    {{csrf_field()}}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input name="nama" type="text" class="form-control" id="formGroupExampleInput" placeholder="Contoh: Nama">
                                                        </div>
                                                        @error('nama')
                                    ...
                                    <table id="example1" class="table table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#" class="btn btn-danger btn-sm hapus" kategori_id="{{$kategori->id}}"><i class="fa fa-trash"></i>HAPUS</a>
                                                    <a href="/kategoribarang/{{$kategori->id}}/ubah" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i>EDIT</a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                            @endforeach
    ...
    <script>
        $(function() {
            $('.hapus').click(function(){
                var kategori=$(this).attr('kategori_id');
                swal({
                    title: "Yakin",
                    text:'Mau menghapus Kategori ini',
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                    })
                    .then((willDelete) => {
                    if (willDelete) {
                        window.location="/kategoribarang"+"/"+kategori+"/delete";
                    } else {      
                    }
                    });
            });
