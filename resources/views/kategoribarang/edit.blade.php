                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <!-- /.box-body -->
                            <form role="form" method="POST" action="/kategoribarang/{{$kategoribarang->id}}/update">
                                {{csrf_field()}}
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="kategori" class="form-control" id="exampleInputEmail1" value="{{$kategoribarang->kategori}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" id="exampleInputPassword1" value="{{$kategoribarang->nama}}">
                                        </div>
                                    </div>
