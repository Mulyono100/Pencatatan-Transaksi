...
<head>
    ...
    <!-- daterange picker -->
    <link rel="stylesheet" href="{{asset('temptele/bower_components/bootstrap-daterangepicker/daterangepicker.css')}}">
    <!-- bootstrap datepicker -->
    <link rel="stylesheet" href="{{asset('temptele/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css')}}">
...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <div class="row justify-content-md-center">
                    <div class="col-md-6">
                        <div class="box">
                            ...
                            <!-- /.box-body -->
                            <form role="form" method="POST" action="/suplier/{{$suplier->id}}/edit">
                                {{csrf_field()}}
                                <div class="box-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="nama" class="form-control" id="exampleInputEmail1" value="{{$suplier->nama}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="email" value="{{$suplier->email}}" class="form-control" placeholder="Email">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="handphone" value="{{$suplier->handphone}}" class="form-control" data-inputmask='"mask": "(999) 9999-99999"' data-mask>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="exampleFormControlTextarea1" name="alamat">{{$suplier->alamat}}</textarea>
                                    </div>
                                ...
                                <div class="box-footer">
                                    <button type="submit" class="btn btn-primary" onclick="ubah()" id="ubah">Submit</button>
                                </div>
                            </form>
                        </div>
    ...
    <script src="{{asset('templete/bower_components/moment/min/moment.min.js')}}"></script>
    <script src="{{asset('templete/bower_components/bootstrap-daterangepicker/daterangepicker.js')}}"></script>
    <!-- bootstrap datepicker -->
    <script src="{{asset('templete/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js')}}"></script>
    <!-- bootstrap color picker -->
    <script src="{{asset('templete/bower_components/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js')}}"></script>
    <!-- bootstrap time picker -->
    <script src="{{asset('templete/plugins/timepicker/bootstrap-timepicker.min.js')}}"></script>
    <!-- bootstrap color picker -->
    <!-- page script -->
